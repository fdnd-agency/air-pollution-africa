...
<main>
	<section>
		<h2>Data & API</h2>
		<p>This page provides access to the Kumasi measurement dataset. Download the full dataset or use the public API for research, analysis, and integration.</p>
		<article>
			<a href="/">Back to map</a>
			<a href="/api-key/request">Request API</a>
		</article>
	</section>
	<section>
		<h2>Donwload</h2>
	...
	<section>
		...
		<p class="copyCode">
			GET <span
				class="endpoint"
				data-path="/api/public/data?apiKey=YOUR_KEY"
			></span>
		</p>
		<!--  -->
		<h3>Pagination</h3>
		...
		<p class="copyCode">
			GET <span
				class="endpoint"
				data-path="/api/public/data?apiKey=YOUR_KEY&page=2&limit=5"
			></span>
		</p>
		<!--  -->
		...
		<p class="copyCode">
			GET <span
				class="endpoint"
				data-path="/api/public/data?apiKey=YOUR_KEY&active=true"
			></span>
		</p>
		<!--  -->
		...
		<p class="copyCode">
			GET <span
				class="endpoint"
				data-path="/api/public/data?apiKey=YOUR_KEY&point=14"
			></span>
		</p>
		...
		<p class="copyCode">
			GET <span
				class="endpoint"
				data-path="/api/public/data?apiKey=YOUR_KEY&pointMin=5&pointMax=10"
			></span>
		</p>
		<!--  -->
		...
		<p class="copyCode">
			GET <span
				class="endpoint"
				data-path="/api/public/data?apiKey=YOUR_KEY&includeMeasurements=true"
			></span>
		</p>
		<!--  -->
		...
		<p class="copyCode">
			GET <span
				class="endpoint"
				data-path="/api/public/data?apiKey=YOUR_KEY&includeMeasurements=true&mFrom=2025-9&mTo=2025-11"
			></span>
		</p>
		...
		<p class="copyCode">
			GET <span
				class="endpoint"
				data-path="/api/public/data?apiKey=YOUR_KEY&includeMeasurements=true&mFrom=2025-11&mTo=2025-11"
			></span>
		</p>
		<!--  -->
		...
		<p class="copyCode">
			GET <span
				class="endpoint"
				data-path="/api/public/data?apiKey=YOUR_KEY&includeMeasurements=true&latestOnly=true"
			></span>
		</p>
		<!--  -->
		...
		<p class="copyCode">
			GET <span
				class="endpoint"
				data-path="/api/public/data?apiKey=YOUR_KEY&includeMeasurements=true&mLimit=6"
			></span>
		</p>
	</section>
	<section>
